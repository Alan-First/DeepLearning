...
'''
@File         :TextCNN.py
@Description  :用torchtext加载imdb文件并将其转化为数据集，主要复制粘贴来的
@Time         :2022/04/30 19:59:20
@Author       :Hedwig
@Version      :1.0
'''
...
# 定义字段，并按照指定标识化函数进行分词
# 可以传入revtok、subword、spacy、moses，表示分别使用revtok、NTLK、en模块的SpaCy库、scaremoses字段处理
...
Epoch: 01 | Epoch Time: 0m 19s
        Train Loss: 0.543 | Train Acc: 70.38%
         Val. Loss: 0.338 |  Val. Acc: 85.63%
Epoch: 02 | Epoch Time: 0m 18s
        Train Loss: 0.308 | Train Acc: 86.85%
         Val. Loss: 0.277 |  Val. Acc: 88.32%
Epoch: 03 | Epoch Time: 0m 18s
        Train Loss: 0.215 | Train Acc: 91.35%
         Val. Loss: 0.271 |  Val. Acc: 89.26%
Epoch: 04 | Epoch Time: 0m 18s
        Train Loss: 0.138 | Train Acc: 94.79%
         Val. Loss: 0.287 |  Val. Acc: 89.24%
Epoch: 05 | Epoch Time: 0m 19s
        Train Loss: 0.086 | Train Acc: 96.71%
         Val. Loss: 0.332 |  Val. Acc: 89.26%
Test Loss: 0.273 | Test Acc: 88.50%

预测 sen =  This film is terrible
预测 结果: 0.0693889856338501

预测 sen =  This film is great
预测 结果: 0.8973960876464844

预测 sen =  I like this film very much！
预测 结果: 0.6285960674285889
'''